...
Gem::Specification.new do |spec|
  ...
  spec.summary     = 'Facilitates Server-Side Rendering (SSR) in Rails applications.'
  spec.description = 'Provides helper methods and configuration to forward rendering requests ' \
